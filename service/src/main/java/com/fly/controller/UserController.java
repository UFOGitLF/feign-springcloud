...
public class UserController {
    ...
    public Rr getAll(@RequestParam(value = "pageNo") Integer pageNo,
                     @RequestParam(value = "pageSize") Integer pageSize) {

        return Rr.ok(userService.findAll(pageNo,pageSize));

    }
    @GetMapping(value = "/condition")
    @ApiOperation(value = "按条件查询")
    public Rr getUsersByCondition(@RequestParam(value = "pageNo") Integer pageNo,
                                  @RequestParam(value = "pageSize") Integer pageSize,
                                  UserQuery userQuery){

        return Rr.ok(userService.findAll(pageNo,pageSize,userQuery));
